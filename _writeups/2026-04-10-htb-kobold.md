...
| Dificultad | F├ícil |
| Tags | `RCE`, `LFI`, `Path Traversal`, `Reutilizaci├│n de credenciales`, `Escalada de privilegios con Docker` |
...
## Metodolog├¡a de an├ílisis del vector inicial
...
## Investigaci├│n de vulnerabilidades y se├▒ales de riesgo
...
- Los permisos de grupo aparentemente inocentes pueden convertirse en ejecucion de codigo al combinarse con otra aplicacion mal dise├▒ada.
